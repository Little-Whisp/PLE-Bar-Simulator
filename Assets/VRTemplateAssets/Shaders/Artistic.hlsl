...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
Shader "FronkonGames/Artistic/OilPaint"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 ArtisticFrag(ArtisticVaryings input) : SV_Target
            {
                float4 color = SAMPLE_MAIN(input.texcoord);
                color.rgb = ColorAdjust(color.rgb);
                return color;
            }
            ENDHLSL
        }
